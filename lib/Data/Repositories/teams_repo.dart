...
class TeamsRepo {
  ...
  Future<Teams?> searchByTeam(String searchText, int leagueId) async {
    try {
      var response = await http.get(Uri.parse(
          "https://apiv2.allsportsapi.com/football/?&met=Teams&APIkey=e0a1aa20543e8be54adb246f127ae6b89af0bb6c96b83ea255ee5b29489ce114&leagueId=$leagueId&teamName=$searchText"));
